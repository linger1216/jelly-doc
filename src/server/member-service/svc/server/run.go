...
import (
	...
	// This Service
	"github.com/linger1216/jelly-doc/src/server/member-service/handlers"
...
func NewEndpoints(service pb.MemberServer) svc.Endpoints {
	// Business domain.
