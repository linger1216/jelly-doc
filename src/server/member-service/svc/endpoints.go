...
func (e Endpoints) Create(ctx context.Context, in *pb.CreateMemberRequest) (*pb.CreateMemberResponse, error) {
	response, err := e.CreateEndpoint(ctx, in)
	if err != nil {
		return nil, err
	}
	return response.(*pb.CreateMemberResponse), nil
}

func (e Endpoints) Get(ctx context.Context, in *pb.GetMemberRequest) (*pb.GetMemberResponse, error) {
	response, err := e.GetEndpoint(ctx, in)
	if err != nil {
		return nil, err
	}
	return response.(*pb.GetMemberResponse), nil
}

func (e Endpoints) List(ctx context.Context, in *pb.ListMemberRequest) (*pb.ListMemberResponse, error) {
	response, err := e.ListEndpoint(ctx, in)
	if err != nil {
		return nil, err
	}
	return response.(*pb.ListMemberResponse), nil
}

func (e Endpoints) Update(ctx context.Context, in *pb.UpdateMemberRequest) (*pb.EmptyResponse, error) {
...
func (e Endpoints) Delete(ctx context.Context, in *pb.DeleteMemberRequest) (*pb.EmptyResponse, error) {
...
func MakeCreateEndpoint(s pb.MemberServer) endpoint.Endpoint {
...
func MakeGetEndpoint(s pb.MemberServer) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
...
func MakeListEndpoint(s pb.MemberServer) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
...
func MakeUpdateEndpoint(s pb.MemberServer) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
...
func MakeDeleteEndpoint(s pb.MemberServer) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
