...
// MakeGRPCServer makes a set of endpoints available as a gRPC ApiServer.
func MakeGRPCServer(endpoints Endpoints, options ...grpctransport.ServerOption) pb.ApiServer {
...
// grpcServer implements the ApiServer interface
...
// Methods for grpcServer to implement ApiServer interface
